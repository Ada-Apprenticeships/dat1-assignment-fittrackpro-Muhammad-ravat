...
CREATE TABLE staff (
    ...
    email VARCHAR(100) NOT NULL,
    phone_number CHAR(8) NOT NULL,
    position VARCHAR(100) NOT NULL CHECK (position IN ('Trainer', 'Manager', 'Receptionist', 'Maintenance')),
...
CREATE TABLE equipment (
    ...
    name VARCHAR(100) NOT NULL,
    type VARCHAR(100) NOT NULL CHECK (type IN ('Cardio', 'Strength')),
    purchase_date CHAR(10) NOT NULL,
    last_maintenance_date CHAR(10) NOT NULL CHECK(last_maintenance_date >= purchase_date),
    next_maintenance_date CHAR(10) NOT NULL CHECK(next_maintenance_date >= last_maintenance_date),
    location_id INTEGER,
...
CREATE TABLE class_schedule (
    ...
    end_time VARCHAR(50) NOT NULL CHECK(end_time > start_time),
...
CREATE TABLE member_health_metrics (
    ...
    member_id INTEGER,
    measurement_date CHAR(10) NOT NULL,
...
CREATE TABLE equipment_maintenance_log (
    ...
    maintenance_date CHAR(10) NOT NULL,
